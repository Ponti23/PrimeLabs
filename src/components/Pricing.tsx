  ...
  return (
    <section id="pricing" className="py-24 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <p className="text-gold text-sm font-bold tracking-widest uppercase mb-3">Transparent Pricing</p>
          <h2 className="text-4xl md:text-5xl font-black">Choose Your Package</h2>
          <p className="text-white/50 mt-4 max-w-xl mx-auto">
            Flat-rate pricing — no surprises. All packages include our mobile service; we come to you.
          </p>
        </div>
              ...
              return (
                <div
                  ...
                  className={`relative rounded-2xl p-8 border transition-all duration-300
                    ...
                    ${pkg.highlight
                      ? 'bg-gold/5 border-gold/40 animate-pulse-glow'
                      : 'bg-surface-2 border-white/5 hover:border-white/15 hover:shadow-[0_8px_32px_rgba(0,0,0,0.4)]'
                    }
                ...
                >
                  {pkg.highlight && (
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                      <span className="bg-gold text-black text-xs font-black px-3 py-1 rounded-full tracking-wide uppercase shadow-[0_0_16px_rgba(0,212,255,0.5)]">
                        Best Value
                      </span>
                    </div>
                  )}

                  {/* Shimmer bar on Gold card */}
                  {pkg.highlight && (
                  ...
                  <div className="mb-6">
                    <h3 className={`text-lg font-bold mb-1 ${pkg.highlight ? 'bg-gradient-to-r from-[#00D4FF] to-[#40E0FF] bg-clip-text text-transparent' : 'text-white'}`}>
                      {pkg.name}
                    </h3>
